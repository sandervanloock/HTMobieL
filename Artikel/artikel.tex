...
\newcommand{\framework}[2]{\emph{\MakeUppercase{#1} (\textbf{#2}): }} %enkel in usage stukje om framework in te leiden
...
%% The file named.bst is a bibliography style file for BibTeX 0.99c
\bibliographystyle{named}
\bibliography{literatuurstudie-tex,vergelijking,evaluatie}
