...
This is a HTML5 application,  written in ST,  that lines up all possibilities of the framework combined with the corresponding code.
...
Alse,  ~\cite{Inc.} states that Sencha is the largest provider of open-source HTML5 application frameworks with more than two million developers.  
...
Also we left out the following challenges in the evaluation of the usage:
...
\bibliography{../Referenties/literatuurstudie-tex,../Referenties/vergelijking-tex,../Referenties/evaluatie-tex}
