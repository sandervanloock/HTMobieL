...
The need for a custom date picker with only a month and year needed to be hard coded.
...
\framework{jQM}{X}
Because of the lack of support on mobile browsers for the \code{required} attribute~\cite{Deveria2013}, the plugin of Zaefferer~\cite{Zaefferer2013} was used.
This plugin also provides built in validation methods that were needed: \code{required}, \code{number}, \code{email} and \code{date}.
