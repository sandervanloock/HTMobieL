...
Next, we explore the ways to making mobile applications.
Because of the emphasis on mobile HTML5 application, we look at the mobile web browsers and the three building blocks of such applications: HTML5, CSS3 and JavaScript.
...
It may not come as a shock that all those mobile devices come in different shapes and sizes and are packed with different software.
...
We access the Internet more and more form our browsers on our mobile devices.
...
% TODO verder uitleggen login screen
...
% Making it offline (C3)

%\challenge{Load screen and dialog}
%Show load screen (C1).
%Dialog (C2).

%\challenge{Data conversion}
...
% alle niet besproken challenges
% 3 andere criteria
