...
One solution is to build mobile web applications written among other things in HTML5.
...
The tree building blocks of (mobile) web (application) development are HTML5, CSS3 and JavaScript.
...
Secondly, it is possible the achieve transition effects without the use of JavaScript.
...
The DOM is an API for HTML documents~\cite{Hegaret2004}.
