...
%TODO Tim: onderstaande zin relevant?
%They run one every device with a web browser and only one code base is needed.
...
Those users can't benefit of the latest bells and whistles, particularly the new features of HMTL5, on their devices.
...
Advantages~\cite{Accenture2012} of web applications are the presence of a browser on mobile devices, so everyone can use it directly without installing the app first and regardless of their mobile OS.
...
The scores for the popularity criterion can be found in table~\ref{tabel:evaluatie-popularity}. 
