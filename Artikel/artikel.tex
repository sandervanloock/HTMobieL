...
%TODO namen criteria bekijken (feature support, device support)
...
As at the time of writing, \jqma{} released version~1.3.1 \cite{Parker2013a}. %TODO site aanpassen
...
Switching pages in a multi-page appication is done with AJAX by default.
...
A commercial license is also available but there is no concrete information available.
The authors contacted TapQuo via email to obtain more info, but as of writing, they did not receive any answer.
...
\kendoa{} and \sta{} are both controlled by a company and because of the fact that the POC is a typical application for a company, this can also explain the good results.
...
\kendoa{} and \sta{} both have six perfect challenges.
\kendoa{} fails on two challenges, while \sta{} only fails on one.
...
Only \kendoa{} accomplishes both date and month pickers with a specified range and \lungo{} lacks support for an option field.
...
De maximum scores voor \sta{},  \kendoa{},  \jqma{} and \lungo{} are respectively $96$, $104$, $104$ and $80$.
...
\kendoa{}, \jqma{} and \lungo{} reuse the code to implement the \chal{pdf}, \sta{} has a plugin available that depend on the PDF.JS,  a PDF-renderer from Mozilla~\cite{Gal2010}.
...
\lungo{} is about have of the time faster than \jqma{}, \kendoa{} or \sta{}.
