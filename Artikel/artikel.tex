...
\begin{equation}
\begin{split}
 \text{Av. download time}_f= \frac{\sum_{c=1}^{8}{\left(\widehat{l}_{f,c,login}+\widehat{l}_{f,c,login_{cache}}\right)}}{8}
...
\begin{equation}
\text{Performance}'_r = \frac{\text{Average download time}_f}{\text{User experience}_f}
...
As a result,  the average download times were remarkably large.
The user experience tests gave an opposite result because after the initial waiting time,  \sta{} had the fastest response times.
