...
\newcommand{\framework}[2]{#1 #2} %enkel in usage stukje om framework in te leiden
...
%\subsubsection{Sencha Touch} %TODO best veranderen om niet dezelfde titels te laten terugkomen
%forms
...
%TODO upload evidence plugin 

%TODO autocompletion plugin
...
%splitscreen en aanpassen naar device
