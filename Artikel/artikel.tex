...
Therefor,  the loading time of the login application ($l_{f,c,login}$) will be measured on eight devices.
Also,  the loading time for a cached version of the login application ($l_{f,c,login_{cache}}$) will be recorded.
