...
\begin{itemize}
\item HTCDesireZ (zie tabel~\ref{tabel:evaluatie-ondersteuning-htc}),
\item GalaxyTab (zie tabel~\ref{tabel:evaluatie-ondersteuning-galaxytab}),
\item GalaxyS (zie tabel~\ref{tabel:evaluatie-ondersteuning-galaxys}),
\item Nexus 7 (zie tabel~\ref{tabel:evaluatie-ondersteuning-nexus}),
\item iPad1 WiFi (zie tabel~\ref{tabel:evaluatie-ondersteuning-ipad1}),
\item iPad3 4G WiFi (zie tabel~\ref{tabel:evaluatie-ondersteuning-ipad3}),
\item iPhone 3GS (zie tabel~\ref{tabel:evaluatie-ondersteuning-iphone3}),
\item iPhone 4S (zie tabel~\ref{tabel:evaluatie-ondersteuning-iphone4}).
\end{itemize}
