...
%dialoogvenster
Een dialoogvenster wordt in \kendo{} \code{ModelView} genoemd (niet te verwarren met het \code{View Model} van het MVVM-ontwerppatroon).
...
Voor \code{select}-items werden de andere niet-benodigde lijstitems verwijderd worden.
