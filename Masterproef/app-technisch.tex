...
\label{tabel:evaluatie-gebruik-anatomie-app}
\end{table}
...
In tabel \ref{tabel:evaluatie-gebruik-toestel-app} worden de resultaten getoond van de drie deeluitdagingen van \uit{toestel}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
...
\label{tabel:evaluatie-gebruik-toestel-app}
\end{table}
...
In tabel \ref{tabel:evaluatie-gebruik-laadscherm-app} worden de resultaten getoond van de twee deeluitdagingen van \uit{laadscherm}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
...
\label{tabel:evaluatie-gebruik-laadscherm-app}
\end{table}
...
Net voor de AJAX-verzoek zal het laadscherm worden getoond en in de \term{callback} van de AJAX-verzoek zal het worden verborgen.
...
In tabel \ref{tabel:evaluatie-gebruik-formulieren-app} worden de resultaten getoond van de zeven deeluitdaging van \uit{formulieren}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
...
\label{tabel:evaluatie-gebruik-formulieren-app}
\end{table}
...
Tekst-, e-mail en nummervelden werden gaangemaakt met de eerste drie velden.
...
In tabel \ref{tabel:evaluatie-gebruik-vullen-app} worden de resultaten getoond van de twee deeluitdaging van \uit{vullen}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
...
\label{tabel:evaluatie-gebruik-vullen-app}
\end{table}
...
In tabel \ref{tabel:evaluatie-gebruik-autoaanvullen-app} worden de resultaten getoond van de twee deeluitdagingen van \uit{autoaanvullen}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
...
In tabel \ref{tabel:evaluatie-gebruik-afbeelding-app} worden de resultaten getoond van de drie deeluitdagingen van \uit{afbeelding}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
...
\label{tabel:evaluatie-gebruik-afbeelding-app}
\end{table}
...
In tabel \ref{tabel:evaluatie-gebruik-validatie-app} worden de resultaten getoond van de vier deeluitdaging van \uit{validatie}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
...
\label{tabel:evaluatie-gebruik-validatie-app}
\end{table}
...
In tabel \ref{tabel:evaluatie-gebruik-handtekening-app} worden de resultaten getoond van de deeluitdaging van \uit{handtekening}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
...
Deze maakt gebruikt van het HTML5 \code{canvas} en retourneert de handtekening als Base64 tekst.
...
In tabel \ref{tabel:evaluatie-gebruik-ajax-app} worden de resultaten getoond van de vier deeluitdagingen van \uit{ajax}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
...
\label{tabel:evaluatie-gebruik-ajax-app}
\end{table}
...
In jQuery is de functie \code{parseJSON} aanwezig, maar aangezien in de AJAX-verzoek ingesteld wordt dat JSON wordt verwacht, parst jQuery al automatisch het antwoord. 
...
In tabel \ref{tabel:evaluatie-gebruik-lijsten-app} worden de resultaten getoond van de drie deeluitdagingen van \uit{lijsten}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
...
\label{tabel:evaluatie-gebruik-lijsten-app}
\end{table}

\paragraph{\st}
Een lijst kan voorzien worden van een sjabloon.
Dit is een instantie van de \code{Ext.XTemplate} klasse zijn.
...
In tabel \ref{tabel:evaluatie-gebruik-pdf-app} worden de resultaten getoond van de twee deeluitdagingen van \uit{pdf}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
...
\label{tabel:evaluatie-gebruik-pdf-app}
\end{table}
...
In tabel \ref{tabel:evaluatie-gebruik-offline-app} worden de resultaten getoond van de twee deeluitdagingen van \uit{offline}.
Onder de tabel wordt per raamwerk verklaard waarom dat resultaat werd behaald.
