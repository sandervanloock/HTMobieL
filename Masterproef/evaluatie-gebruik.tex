...
%TODO
% ST en Kendo hebben beide de meeste capaciteit. verklaren door architectuur, wordt gepusht door een bedrijf. tussen deze 2 is het offline wel opmerkelijk
% Daarna behaalt jQM ruim de helft, terwijl Lungo  ondermaats scoort
% Vooral automatisch vullen formulieren, lijsten en validatie worden slecht ondersteund. Lijsten 
% Bij Lungo is er een totale ontbreking van validatie en meer geavanceerde formulierelement scoort Lungo zeer slecht.
% AJAX wordt over het algemeen zeer goed ondersteund (behalve die hack bij Lungo)
% De meer geavanceerdere dingen heb je ofwel geluk als je een plugin vindt of je moet het zelf implementeren
% Laadschermen en dialoogvensters worden overal ten volle ondersteund vanuit de raamwerken.
% Kendo heeft 6 perfecte uitdagingen, ST 6, jQM 3 en Lungo 1.
% ST 1 maal onder de helft, Kendo 2, jQM 4, Lungo 7
...
\caption{Gebruik voor \uit{anatomie}}
...
\caption{Gebruik voor \uit{toestel}}
...
\caption{Gebruik voor \uit{laadscherm}}
...
\caption{Gebruik voor \uit{formulieren}}
...
\caption{Gebruik voor \uit{vullen}}
...
\caption{Gebruik voor \uit{autoaanvullen}}
...
\caption{Gebruik voor \uit{afbeelding}}
...
\caption{Gebruik voor \uit{validatie}}
...
\caption{Gebruik voor \uit{handtekening}}
...
\caption{Gebruik voor \uit{lijsten}}
...
\caption{Gebruik voor \uit{offline}}
