...
De tweede methode voor het invullen van formulieren maakt gebruikt van een \code{Navigationview} en wordt besproken in \ref{sec:evaluatie-gebruik-lijsten}.
...
%TODO dropdownmenu = selectieveld?
...
%TODO ik net dat ge met HTML5 net zo goed het attribuut disabled kunt toevoegen en het werkt ook..
...
%TODO moet ik bij kendo vermelden dat de HTML5 attributen worden gebruikt maar het framework ze omvormt zodat het wel ondersteund is?
...
%TODO is een api niet meestal gedocumenteerd?
...
\paragraph{\lungo}
%TODO twee zinnen nogal contradictorisch.  Een plugin zou dus wel degelijk mogelijk zijn,  je hebt er gewoon niet voor gekozen?
...
Een \code{Proxy} kan de \term{localStorage} van de browser gebruiken of data verzenden via AJAX.  
Hierbij kunnen \code{Readers} geconfigureerd worden om data van de server te lezen of naar de server te schrijven.
...
\paragraph{\lungo}
%TODO twee refs naar jqm.  Mss krijgen lezers na een tijdje wel de indruk dat ze op dezelfde library steunen ofzo.  
Het laden van data in een lijst dient zelf geprogrammeerd te worden.
...
\paragraph{\st}
Zoals besproken in sectie~\ref{sec:evaluatie-gebruik-ajax} kan een \code{Store} voozien worden van een \code{Proxy} die data lokaal opslaat aan klantzijde.
