...
%TODO ik heb [H] weggehaald, gonzalo opmerking van die spacing

%TODO alleen-lezen ipv read only zal de leesbaarheid ook vergemakkelijken
...
\paragraph{\kendo}
%TODO ik weet dat je het over <section> hebt, maar is dat nu nog wel duidelijk? in de volgende zin spreek je ook algemeen over tags ipv specifiek die kop- en voet-tag
Het skelet van een \code{View} kan in een HTML-sectie worden geschreven.
...
%TODO onderstaande zin ook 'technisch'? 
...
%TODO is dit dan iets specifiek technisch?
...
%TODO dat neigt naar evaluatie, nee? is ook voor iedereen van toepassing?
...
%TODO worden onder andere ondersteund = werden gebruikt?
...
%TODO door een minimum en maximum op te geven?
 Het bereik van de selectie kan worden ingeperkt door de \code{min} en \code{max} eigenschap te zetten.
...
%TODO de code '(View) Model' vind ik al redelijk technisch. je vertelt ook over die binding van formulierelementen, maar dat is pas nodig in een andere challenge. die laatste zin is precies de hele 'clou' van het verhaal
 ...
 Door de dubbele binding tussen het formulier en het \code{(View) Model} zal ook de inhoud van de formulierelementen worden gewist.
...
%TODO reden geldt voor iedereen? mss ergens anders plaatsen?
...
%TODO hieronder houden in tekst?
...
%TODO of gewoon zeggen 'het gebeurt via js?'
...
Bij \code{radio}- en \code{select}velden heet deze eigenschap \code{disabled}.


\paragraph{\kendo}
Het invullen van een formulier steunt op de MVVM-architectuur en is gelijkaardig aan het resetten van een formulier.
%TODO ik begrijp dit hier zelf niet. die laatste twee zinnen zijn voor mij genoeg?
De dubbele binding tussen een formulier en \code{(View) Model} wordt met een HTML-tag aangegeven.
...
%TODO te vage abstractie misschien?
...
%TODO ik vind die opsomming nu niet meer zo relevant, de clou is dat de aangeboden opties het niet toelaten
...
%TODO enkel vertellen wat relevant is? ook op het einde code met alle mogelijkheden, je gebruikt enkel 'startswith' neem ik aan?
...
%TODO beetje rare zin, wrs ook voor die negatievorm van hetgene je eigenlijk nodig hebt voor de POC
...
%TODO mode (Eng) = modus (Ned), dus modi ipv modes. anders mss gewoon 'manieren'
Deze \term{widget} kan in twee modes worden gebruikt: synchroon of asynchroon.
...
%TODO gewoon zeggen wat je hebt gebruikt, al die andere mogelijkheden vertel je al in het hoofdstuk raamwerken?
...
%TODO dus enkel onderstaande zin vind ik relevant
Er werd gekozen om de PHP-implementatie te gebruiken.
%TODO ik zo die succes callback weglaten, en dat met die andere zin binden
...
%TODO algemene tekst die voor iedereen van toepassing is?
...
\paragraph{\st}
%TODO zeggen die twee zinnen, niet 2x hetzelfde, maar de ene algemeen en de andere technischer?
...
% \end{description}
%TODO in het begin redelijk technisch, ook met die exacte reguliere expressie enzo
...
%TODO is dat relevant, gewoon werking van validation uit te doeken doen? bij ST zeg je zoiets niet dacht ik
...
%TODO veel zeggen wat je 'kan' doen, maar wat heb je gedaan? wat heb je gebruikt?
...
\paragraph{\st}
%TODO heel veel 'kan' en uitleg wat er allemaal aanwezig is, maar wat heb je nu gebruikt?
...
%TODO wat heb je nu gebruikt bij de implementatie? of beide?
...
%TODO is dat niet allemaal wat technisch?
...
\paragraph{\st}
%TODO redelijk technisch, mss luchtiger maken ouzo?
