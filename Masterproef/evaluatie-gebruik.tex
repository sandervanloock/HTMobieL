...
Tekst-, e-mail en nummervelden worden bij het renderen tot HTML5-invoertypes omgevormd en bijgevolg worden op mobiele toestellen bijhorende virtuele toetsenborden weergegeven.
...
\paragraph{\kendo}
 ...
 \term{Datepickers} worden als widget aangeboden in \kendo Web.
...
\end{description}
De controle of een opgegeven waarde een nummer is kan met de \code{format} regel en de \code{\textbackslash{}d+} reguliere expressie. 
...
Een \code{proxy} voor opslag aan klant zijde kan zowel in het RAM-geheugen als de lokale opslag van de browser opslaan.  
