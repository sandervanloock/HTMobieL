...
Een tabbar moet met een \code{Buttongroup} worden gemaakt,  dit is een lijst van knopppen.
...
Hier moet de overeenkomstige \code{View} zichbaar worden gemaakt met behulp van CSS-manipulaties.
...
Het toevoegen van de plug-in zal een ivoerelement beschikbaar maken dat suggesties met een dropdownmenu weergeeft.
...
Dit element maakt gebruikt van het HTML5 \code{canvas} en retourneert de handtekening als Base64-tekst.
...
Indien dit het geval is, wordt automatisch naar naar het startscherm genavigeerd en de \code{DataSource} met informatie van de gebruiker ingevuld.
