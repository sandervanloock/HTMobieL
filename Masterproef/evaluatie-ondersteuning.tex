...
Een laatste opmerking bij de POC geïmplementeerd in \lungo{} is dat het \term{tap event} werd gebruikt om te navigeren.
...
Van alle $8$ apparaten is de \iphoneiii{} het oudst (officiële voorstelling in juni 2009) gevolgd door de \gs{} (officiële voorstelling in maart 2010). %TODO referenties
...
%TODO Tim: Lungo tap probleem ergens vermelden
...
Iedere implementatie die onderliggend FileReaderAPI gebruik, heeft geen ondersteuning op Android versies 2.3 en lager of iOS versies lager dan 6.0~\cite{Deveria2013a}.
...
Dit komt omdat de grootte van de fotos de limiet van de \code{local storage} overschreiden.%TODO exacte limiet localstorage refereren?
Hierdoor moet de camera aan de voorkant worden gebruikt of een afbeelding met lagere resolutie worden gekozen.
De \ipadi{} biedt geen ondersteuning voor het formulierveld van het type \code{file} en zal het opladen van een afbeelding dus ook niet ondersteunen.%TODO referentie?
Alle raamwerken behaalden een score van \score{5}{8}
...
Alle onderzochte toestellen ondersteunen de \term{canvas}~\cite{Deveria2013c} en de drie raamwerken behalen vervolgens de maximumscore \score{8}{8}. 
...
De score voor deze drie raamwerken is dus \score{5}{8}.
...
\st{} haalt een score van \score{6}{8} omdat de plug-in de \gs{} wel ondersteund in tegenstelling tot de drie andere raamwerken.
