...
Liggend worden sommige labels wel zichtbaar
...
De laatste twee deeluitdagingen halen de maximumscore.
...
Nog een opmerking,  op alle toestellen wordt automatisch een virtueel toetsenbord weergegeven ondanks dat de invoer uit de \term{date-picker} moet worden gekozen.
