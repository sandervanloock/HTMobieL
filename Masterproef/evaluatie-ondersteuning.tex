...
Door de lage resolutie van de \gtab{} werd deze als smartphone gecategoriseerd op \st{},  \jqm{} en \lungo{}.
Bij \jqm{} en \lungo{} geldt dit niet wanneer de applicatie liggend wordt opgestart.
\kendo{} herkende in zowel in staande als liggende modus de \gtab{} wel correct.
...
Alle smartphones en de \gtab{} vertoonden een probleem bij de labels van de \code{optie}knoppen.
...
De tweede deeluitdaging faalt bij de \htc{} en \gtab{} aangezien geen e-mailtoetsenbord ondersteund wordt.
%TODO sander: referentie?
De schakelaar die \st{} voorziet, werkte op elk toestel.


\paragraph{\kendo} \score{34}{40}
Alle Android toestellen toonden een wit kader bij \term{read-only} \term{widgets}.
...
De schakelaar en optievelden werkte op elk apparaat.
...
Dit komt omdat de grootte van de foto's de limiet van de \code{localStorage} overschrijden.
...
Alle onderzochte toestellen ondersteunen de \code{canvas}~\cite{Deveria2013c} en de drie raamwerken behalen vervolgens de maximumscore 8/8. 
