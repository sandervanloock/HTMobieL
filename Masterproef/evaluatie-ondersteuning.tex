...
De scores voor \uit{afbeelding} zijn gelijk voor alle toestellen waardoor de raamwerken allemaal een score van 5/8 behaalden.
\kendo{}, \jqm{} en \lungo{} gebruiken dezelfde aanpak om deze uitdaging te implementeren, namelijk HTML5 FileReaderAPI.
Deze heeft geen ondersteuning op Android versies 2.3 en lager of iOS versies lager dan 6.0~\cite{Deveria2013c}. 
...
Een gelijkaardige probleem gaat ook op voor Android-apparaten als de foto wordt opgeslaan in de lokale opslag.
