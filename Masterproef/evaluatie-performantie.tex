...
\begin{figure}
  ...
  \subfloat[Loginapplicatie]{
    \includegraphics[width=0.85\textwidth, height=0.3\textheight]{figuren/performantie-login.pdf}
    \label{fig:performantie-login}
  }
  \quad
  \subfloat[Loginapplicatie uit cache]{
    \includegraphics[width=0.85\textwidth, height=0.3\textheight]{figuren/performantie-login-cache.pdf}
