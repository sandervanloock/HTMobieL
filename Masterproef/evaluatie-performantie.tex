...
De gemiddelde downloadtijd voor de loginapplicatie als de loginapplicatie uit cache wordt bepaald volgens formule~\ref{eq:totale-downloadtijd} en \ref{eq:totale-gebruikerservaring}.
...
De verschil van downloadtijden voor de POC wordt nog uitvergroot.
Het mechanisme voor het updaten van de cache zal \st{} nog meer vertragen bij de POC.

Indien \st{} buiten beschouwen wordt gelaten, duurt het eerste keer laden van de POC gemiddeld $5,73$ s. 
Het laden van de versie uit cache duurt slechts gemiddeld $400$ ms.
De eerste keer laden van de loginapplicatie duurt gemiddeld $3,32$ s.
Indien deze uit cache komt, duurt dit gemiddeld nog slechts gemiddeld $420$ ms.
