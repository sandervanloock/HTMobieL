...
De implementatie van \jqm{} gebruikt een plug-in voor validaties, vandaar dat ook de grootte van deze plug-in is opgenomen.
Deze gegevens omvatten drie conclusies.
Ten eerste kan gezien worden dat \lungo{} is geoptimaliseerd voor mobiele ontwikkeling.
Verder is het al dan niet aanwezig zijn van een ontwerppatroon niet uit grootte van de \js{}-bestanden af te leiden.
...
\st{} gebruikte uitgesteld parsen van \js{}-code (zie sectie \ref{sec:evaluatie-performantie-duiding}).
...
%TODO: verschil ST login <-> POC te verklaren aan de te includen bibliotheek
