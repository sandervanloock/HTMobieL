...
\begin{figure}
  ...
  \subfloat[Loginapplicatie]{
    \includegraphics[width=0.45\textwidth, height=0.3\textheight]{figuren/performantie-login.pdf}
    \label{fig:performantie-login}
  }
  \subfloat[Loginapplicatie uit cache]{
    \includegraphics[width=0.45\textwidth, height=0.3\textheight]{figuren/performantie-login-cache.pdf}
...
%TODO sander: updaten duiding, geen POC meer gebruiken, enkel login
...
%TODO is de gemiddelde downloadtijd nu nog relevant? waar steken we die?
...
%TODO Sander: deze data zegt niets! (st meer html dan jqm en kendo