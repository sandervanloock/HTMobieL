...
Eerst zal de performantie worden besproken van de vier raamwerken.
Voor de score van productiviteit wordt naar formule \ref{eq:gebruik} verwezen.

Daarna zal in sectie~\ref{sec:evaluatie-downloadtijd} de totale downloadtijd gedetailleerd worden besproken.
