...
%verschil tussen Android en iOS : (android gemiddeld 5s trager)
...
%gs hoge download tijd voor gecachete poc en login (icons ophalen)
%nexus:  gecachete login 10 keer trager dan gecachete poc
%verschil tussen Android en iOS niet merkbaar (android slechts 60ms trager)
