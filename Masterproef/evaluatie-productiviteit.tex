...
%TODO Sander: tabel met enkel uren van loginapplicatie (sander)
...
Er zijn twee conclusies: het type raamwerk (\js-gedreven of opmaakgedreven) en het al dan niet afdwingen van een architectuur bepalen de productiviteit.
...
% bij POC tussen kui en jqm is som van html en js lager bij kui. Veel minder schrijven maar minder productief dan jqm. (Sander)

%TODO waarom niet in formule?
% is duiding verklaart de uren (per

Het type van het raamwerk (\js- of opmaakgedreven) komt sterk in de tabel naar boven.

%TODO gonzalo: hours includen 
\begin{table}
\centering
\pgfplotstabletypeset[
	column type=l,
...
%TODO referentie safaribooks?  (sander)
