...
\begin{table}
  ...
  \pgfplotstabletypeset[
    ...
    columns/Productiviteit/.style={column name=\textbf{Productiviteit} (Uren), column type={l}},  
  ...
  ]{tabellen/productiviteit-en.csv}
...
Hetzelfde geldt niet bij als naar het aantal lijen geschreven code bij de implementatie van de POC wordt gekeken.
...
% niet zo dat aantal uren implemlentatie het aantal lijen verklaard want lijnen code hangt af van architectuur, niet van uren implementatie
