...
Dit is een desktopapplicatie die het ontwikkelingsproces vergemakkelijkt met een GGI en \term{drag-and-drop}.  
...
\kendo{} en \lungo{} konden gebruik maken van Twitter Bower~\cite{Twitter2013} om de bestanden van de \gh{}-\term{repository} toe te voegen.
...
Een nieuwe \code{Controller},  \code{Store},  \code{Model} of \code{View} genereren kan met of zonder Sencha Cmd.
