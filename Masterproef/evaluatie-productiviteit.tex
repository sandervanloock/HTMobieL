...
Een schatting van de tijd die aan de \term{backend} werd besteed, situeert zich tussen $10$ en $25$ uur. %TODO Sander: dit vermelden? Tim: zeker, maar ik vind die schatting wel te breed van interval (geen interval, gewoon zeggen dat het een probleem is)
...
%TODO Tim: misschien de ondersteuning voor welke OS'es: ok
