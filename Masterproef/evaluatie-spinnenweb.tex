...
Tabel \ref{fig:spinnenweb-final} toont het spinnenweb met de scores voor de $5$ criteria van de $4$ raamwerken.
...
\jqm{} heeft de grootste oppervlakte ($1.87$) en kan als winnaar beschouwd worden.
...
Wanneer er voor een productief raamwerk,  zonder architectuur,  moet worden gekozen dat zeer populair is,  kies dan voor \jqm{}!
...
Positief is dan weer dat \lungo{} de beste laadtijden behaalden omdat \quo{} geoptimaliseerd is in voor mobiele apparaten.
%TODO weglaten.. maakt het verwarrend met onderstaande zin:  TapQuo is dan ook gespecialiseerd in de mobiele gebruikers ervaring.
...
De gebruikservaring gaf echter het tegenovergestelde resultaat want na de initiële wachttijd had \st{} de laagste responstijden.
...
Toestellen met een standaard browser die deze \term{engine} niet bevatten, zoals Windows Phone,  werden niet onderzocht.
