...
Een overzicht van vaak voorkomende resoluties wordt getoond op de figuur \ref{fig:resoluties}.

\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figuren/screen-resolutions.png}
  \caption{Vaak voorkomende resoluties.}
...
Op figuur \ref{fig:android} is het marktaandeel te zien op 1 november 2012. van de verschillende Android versies, waargenomen over een periode van 14 dagen. Het is duidelijk dat Gingerbread (Android 2.3) meer dan de helft van het marktaandeel inneemt.
Applicaties kunnen gedownload worden in Google Play. Android bevat ook een standaard browser (zie infra).

\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figuren/android.png}
  \caption{Marktaandeel Android besturingssystemen op 1 november 2012.}
  \label{fig:android}
\end{figure}
