...
%TODO e-reader er uit smijten dan gewoon kort zeggen dat er nog PDA's, e-readers, enz bestaan
% bij de kenmerken vertel ik toch enkel dingen over smartphone en tablet, dus die e-reader doet er niet echt toe 
...
Deze wordt geprogrammeerd gebruikmakend van een webtechnologie zoals HTML5 (zie \ref{sec:html5}) en wordt geopend vanuit een webbrowser. 
...
Dit is specifiek het geval wanneer de nieuwste kenmerken van HTML5 (zie \ref{sec:html5}) in webapplicaties worden gebruik.
