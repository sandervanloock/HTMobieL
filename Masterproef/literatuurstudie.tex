...
\st{} is net als Ext JS een JavaScript-gedreven raamwerk met een MVC-architectuur.
...
Een licentie voor \kendo{} waarbij één van voornoemde \term{wrappers} mogelijk is kost $\$999$.
...
Panacoda bezit ook Espresso,  een krachtige \term{tool} om applicaties te bouwen en ontwikkelen met \tmp{}.
...
\tmp{} zal van nul worden opgebouwd omdat enkel de code aanpassen niet meer voldoende bleek.  
