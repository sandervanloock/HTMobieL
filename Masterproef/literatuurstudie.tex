...
Zo zijn er bijvoorbeeld de op Google's Android gebaseerde \term{smartphones} zoals de Nexus 4 en de op Windows Phone gebaseerde \term{smartphones} zoals de Nokia Lumia 800.
...
Bij deze bespreking wordt ingegaan op de voornaamste kenmerken van \term{smartphones} en \term{tablets}. De kenmerken en tekst zijn gebaseerd op~\cite{PhilDutson2012}.
...
Op figuur \ref{fig:marketshare-android} is het marktaandeel te zien van de verschillende Android besturingssystemen, waargenomen over een periode van 14 dagen. 
