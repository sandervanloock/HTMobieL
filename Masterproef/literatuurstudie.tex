...
In deze sectie zullen we kort belangrijke eigenschappen bespreken zoals media queries, effecten en lettertypes uit \cite{MacDonald2011}.
...
In deze sectie gaan we inzoomen op bestaande mobiele HTML5 frameworks die gebruik maken van de laatste nieuwe technologieën zoals HTML5, CSS3 en JavaScript. Deze frameworks worden gecategoriseerd volgens twee courante aanpakken: mark-up gedreven en JavaScript gedreven. Bij een mark-up gedreven aanpak wordt de webapplicatie voornamelijk in HTML code geschreven. Daarentegen wordt bij een JavaScript gedreven aanpak hoofdzakelijk in JavaScript geprogrammeerd.
