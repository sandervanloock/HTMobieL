...
\item \textbf{CSS3}.  Hand in hand met HTML5 gaat CCS3 (zie ook infra). Het laat toe om webpagina's op te maken afhankelijk van het formaat van het mobiele apparaat. Ook kunnen webpagina's met effecten worden uitgebreid. 
