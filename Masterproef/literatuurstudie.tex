...
%TODO augmented reality + beter uitwerken (te vaag)
...
%TODO de zinnen hangen niet correct aan elkaar, verschillende view (gebruiker, ontwikkelaar)
...
%TODO waarom?
%TODO december 2013 moet nog komen?
...
%TODO staat MacDonald2011 referentie (HTML5 missing manual) op zn plaats?
...
Eerst worden standaarden zoals de ISO 25010 en de AHP-methode bekeken~(\ref{sec:vergelijken-raamwerken}).
Vervolgens worden de vergelijkingen van raamwerken zoals gevonden in de literatuur en blogposts geclassificeerd ~(\ref{sec:vergelijken-classificatie}).
...
%TODO waarom niet gekozen, ... (zie blad opmerkigen gonzalo)
