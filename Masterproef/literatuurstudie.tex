...
\label{hoofdstuk:2}
Eerst zullen we kijken naar welke mobiele apparaten er allemaal bestaan (\ref{sec:mobiele-apparaten}). 
Vervolgens zullen we kijken wat er onder de motorkap van deze apparaten zit, namelijk welke mobiele besturingssystemen (\ref{sec:mobiele-besturingssystemen}), welke mobiele applicaties (\ref{sec:mobiele-applicaties}) en welke mobiele webbrowsers (\ref{sec:mobiele-webbrowsers}) er bestaan. 
Daarna zullen we het hebben over de drie bouwblokken van het web (\ref{sec:html5-css3-js}):  HTML,  CSS en JavaScript. 
Hierna zullen we het hebben over mobiele HTML5 raamwerken (\ref{sec:mobiele-html5-raamwerken}).  
Ten slotte kijken we naar verschillende manieren om raamwerken te vergelijken (\ref{sec:vergelijken-raamwerken}).
...
Momenteel zijn er al meer dan 1 miljard toestellen in gebruik~\cite{Yang2012}. 
...
Panacoda bezit ook Espresso,  een krachtige \term{tool} voor the M-Project om applicaties te bouwen en ontwikkelen.
...
Ook ondersteunt het HTML5 en CSS3 kenmerken als zoals offline en lokale opslag.
Op het moment van schrijven is The M-Project aan versie 1.4.0.  
Belangrijk op te merken is dat in de zomer van 2013 versie 2.0 wordt verwacht.  
The M-Project zal van nul worden opgebouwd omdat enkel de code aanpassen niet meer voldoende bleek.  
Het voornaamste werkpunt is performantie en platform-onafhankelijkheid~\cite{Panacoda,Laubach2013}.
