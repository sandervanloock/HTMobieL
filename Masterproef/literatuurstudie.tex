...
% TODO Tim: afbeelding misschien vectorieel maken?
\begin{figure}
  \centering
...
%TODO Tim: Wifi, 3G, EDGE beter uitleggen
...
%TODO Tim: dus de vergelijking uit iedere sectie halen en dan pas achteraf vergelijken? zo slecht vind ik het nu ook niet ;-)
...
Een andere aanpak is een \term{native} applicatie. Hierbij zal de gebruiker de applicatie installeren op zijn apparaat. 
...
% TODO Tim: toevoegen data over IE mobile?
\begin{table}
\centering
\begin{tabular}[b]{l r@{,}l}
\toprule
...
% TODO Tim: nederlands woord voor responsive design?
...
\label{sec:motivatie-acht-raamwerken}
De besproken acht raamwerken zijn op drie manieren onder de aandacht van de auteurs gekomen.
...
Ten tweede werden \kendo{} en \moobile{} via het Internet gevonden~\cite{Bristowe}.
...
%TODO Tim: initieel ipv origineel?
...
%TODO Tim: gaan we ervan uit dat de lezer WYSIWYG snapt?
...
% ALGEMEEN: sectie zit goed in elkaar en toont objectief alle mogelijkheden die er al zijn
...
%TODO Tim: een beetje een ongelukkige keuze van het woord 'eigen', omdat het niet eens onze 'eigen' criteria zijn.. misschien eerder 'zelf' 
Anderzijds kunnen ook eigen criteria worden gezocht~(\ref{sec:vergelijken-criteria}).
...
% TODO Tim: ik vind dat niet zo vanzelfsprekend, want eerst wordt geschreven 'HTML5-raamwerken zijn software en om software te vergelijken bestaat er de ISO 25010 standaard' en dan opeens blijken niet alle categorieën even toepasbaar.. ik weet niet zo goed..
Vanzelfsprekend zijn niet alle categorieën even toepasbaar op HTML5-raamwerken.  
% TODO Tim: uitleggen wat hieronder wordt verstaan. ik vind namelijk een 'beveiligde' HTML5-app redelijk relevant voor een bedrijf
...
%TODO Tim: de risico's of het risico?
De risico die een mobiele webapplicatie meebrengt is niet van belang,  het moet vooral efficiënt zijn en voldoening scheppen.
%TODO Tim: wat versta je precies onder 'voldoening scheppen'?
...
%TODO Sander: ik vind deze titel niet zo denderend
%TODO Tim: gewoon 'criteria' anders voorlopig? zo slecht vind ik het niet, in de inleiding vond ik het redelijk duidelijk
\subsection{Criteria}
\label{sec:vergelijken-criteria}

%TODO Tim: ik west niet of de term 'use case' hier wel correct wordt gebruikt. je bedoelt toch gewoon dat er verschillende 'manieren' zijn om raamwerken te vergelijken?
Op het web en in de literatuur kunnen ook \term{use cases} teruggevonden worden waar raamwerken met elkaar worden vergeleken.  
Deze werkwijze verschilt van \term{use case} tot \term{use case} in de gekozen criteria alsook de manier waarop de criteria beoordeeld worden.
...
%TODO Sander: ik vind deze titel niet zo denderend
%TODO Tim: ik zou al sowieso 'bespreking' nemen ipv het werkwoord, maar ik vind het nog cava zo
...
% TODO Tim: ik denk 'onderverdelen' of 'indelen', maar niet de twee
De blogpost verdeelt deze 5 raamwerken in onder \term{Web development frameworks} en \term{Custom API frameworks}.
...
%TODO Tim: misschien termen omdat het allemaal Engels is? of vertalen naar het Nederlands?
\begin{enumerate}
 \item Nativeness
 \item Cross-browser support
 \item Performance
 \item Ease of development
 \item Accessible device hardware
 \item Price of admission
\end{enumerate}

%TODO Tim: waarom en hoe besluiten we dat? de link is me niet zo geheel duidelijk. ik vind deze paragraaf ook zeer abrupt omdat we hier opeens iets concluderen terwijl we hier juist alles objectief vanuit de literatuur willen neerschrijven. eerder zo'n zinnen bij het andere hoofdstuk..
De auteurs besluiten dat geen enkel raamwerk als het beste kan worden beschouwd.
De keuze voor een bepaald raamwerk varieert van project tot project.
...
%TODO Tim: het raamwerk of de raamwerken?
...
%TODO Tim: code efficiëntie aan elkaar, dus wrs met koppelteken
...
%TODO Tim: ik denk locatiegebaseerde, zonder streepje en k
Deze applicatie maakt gebruik van bestaande sociale lokatie-gebaseerde netwerken als Foursquare en Gowalla.
...
Een voorbeeld is \exturl{http://www.jqueryuivskendoui.com/} waar jQuery UI met \kendo{} wordt vergeleken~\cite{Bristowe2012}.
Het bestaat uit één grote tabel die specifieke kenmerken tussen beide raamwerken vergelijkt.
%TODO Tim: geen 'we' gebruiken
