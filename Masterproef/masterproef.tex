...
% commando's voor veelgebruikte woorden, zodat er geen typefouten tegen gemaakt worden
...
\newcommand{\galaxytab}[0]{GalaxyTab}
\newcommand{\galaxys}[0]{GalaxyS}
\newcommand{\nexus}[0]{Nexus 7}
