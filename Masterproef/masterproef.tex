...
Productivity is determined by measuring how long it takes to get acquainted with the framework.
Next,  the usage of the framework is studied by looking which elements are offered by the framework.
The support tests the elements of the framework on eight different devices.
...
The latter determines the smoothness of scrolling through a long list.
