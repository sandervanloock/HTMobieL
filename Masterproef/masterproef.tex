...
%TODO overal [H] verwijderen, dat lost die spacing problemen op
...
%TODO Gonzalo zin
De ontwikkeling van mobiele webapplicatie, gebruikmakend van HTML5, kan als oplossing gezien worden
%TODO onderstaande zin:  helpen bij de functionaliteit (...) en elementen... (idem bij engels)
...
%TODO bekeken gekeken + zin duidelijker maken, want nu is die niet duidelijk Sander ok?
Vervolgens wordt het gebruik van de raamwerken bekeken door te kijken naar welke elementen door het raamwerk zelf of door een plug-in worden aangeboden.
Het ondersteuningscriterium test de elementen van het raamwerk op acht apparaten.
Performantie zal enerzijds de downloadtijd en anderzijds de gebruikerservaring bekijken.
...
%TODO Gonzalo positieve aspecten van st
...
This thesis compares \st{}, \kendo{}, \jqm{} and \lungo{} based on five comparison criteria:  popularity,  productivity,  usability,  support and performance.
...
Next,  the usability of the framework is studied by looking which elements or plugins are offered by the framework.
The support criterion tests the elements of the framework on eight devices.
Performance will look at download time and user experience.

The comparison shows that \jqm{} is the best framework.
Followed by, \kendo{},  \lungo{} and \st{} respectively.
\jqm{} is high productivity,  a major advantage because on the one hand it is well-documented and on the other hand it does not impose an architecture.
The latter,  however,  becomes a disadvantage when looking at the usability.
\kendo{} has the Model-View-View Model architecture as most important advantage.
...
%TODO frameworks in captions niet herhalen
