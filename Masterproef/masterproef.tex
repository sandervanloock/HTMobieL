...
\setup{title={Vergelijkende studie van raamwerken voor de ontwikkeling van mobiele HTML5-applicaties},
  ...
  %TODO titels van assesoren
  assessor={M. Denecker\and F. Van Assche},
...
% onderstaande commando's enkel gebruiken als je hyperref gebruikt
\newcommand{\exturl}[1]{\href{http://#1}{#1}}
\renewcommand{\url}[1]{\href{#1}{#1}}

% onderstaand commando's enkel activeren als je hyperref hebt verwijderd
%\newcommand{\exturl}[1]{\href{http://#1}{#1}}
