...
%TODO nu is het alsof lungo werd gekozen omdat de 7 andere werden uigesloten of werden gekozen. Maar er zijn nog andere frameworks buiten die 8..
Het vierde en laatste onderzochte raamwerk werd daarom \lungo{}.

%TODO nog vermelden dat dit geen ``algemeen aanvaarde'' categorisatie is?  Het is voor ons gemakkelijk..
...
%TODO andere volgorde, geen kopie pasta
...
\paragraph{Tools}
Naast \st{} levert Sencha nog producten die \st{} uitbreiden om het ontwikkelingsproces te versnellen.
Deze worden hieronder opgelijst~\cite{Inc.}.  

\subparagraph{Sencha Architect}
Dit is een desktopapplicatie die het ontwikkelingsproces vergemakkelijkt met een grafische gebruikersinterface~(GGI) en \term{drag-and-drop} commando's~\cite{Sencha2012a}.  
...
%TODO een terminal is "toestel, waarmee een computer op afstand interactief is te bedienen", misschien beter command line tool?
...
%TODO moeten die termen niet met hoofdletter? Sander http://docs.sencha.com/touch/2.1.1/#!/guide/command_app
\begin{description}
...
De \term{open-source} licentie is voor applicaties die zelf een GNU's Not Unix General Public License v3~(GNU GPLv3) opleggen.
...
Op de website van Sencha zijn voor de belangrijkste browsers en bijhorend besturingssystemen \term{scorecards} voorzien om hun compatibiliteit met HTLM5 en \st{} te bespreken~\cite{Inc.}.
...
%TODO zin uit elkaar halen, voelt raar aan dat laatste stuk
...
Een \code{schema} kan ook van een \code{Model} worden voorzien of zelf een \code{Model} beschrijven.
...
Het raamwerk is gebouwd op de jQuery-bibliotheek en maakt dus vaak van jQuery's \term{selectors} gebruik.
...
%TODO ik struikel nog over initiële configuraties :)
...
\item \textbf{Knoppen}
%TODO inhoudsgedeelte blijft raar
...
%TODO gangbare elementen? & nederlands voor slider
\jqm{} biedt alle gangbare elementen voor formulieren aan zoals tekstinvoer, een selectie uit een lijst, een zoekveld, een \term{slider} en een schakelaar. 
%TODO niet consistent met score voor U14 formulieren
...
%TODO subjectieve zin? gesproken taal?
...
%TODO moet die Core daarbij? Dan mss altijd doen als we jQuery-bibliotheek schrijven
Voor de echte functionaliteit wordt beroep gedaan op \js{} en meer bepaald op de jQuery Core bibliotheek. 
%TODO is het erg dat patroon/architectuur/stijl/... door elkaar worden gebruikt?  Ik probeer alleen architectuur te gebruiken
...
Het raamwerk wordt onderhouden door TapQuo dat een Spaans bedrijf is, gespecialiseerd in mobiele gebruikerservaring~\cite{TapQuo2013a}.
...
%TODO ook kendo heeft dit nu? Dit dan ook bij kendo zetten?
...
\paragraph{Documentatie}
%TODO bij evaluatie productiveit zeggen we wel dat er geen boilerplate code op de documentatie staat!
...
%TODO is https://github.com/TapQuo/Lungo.js/blob/master/LICENSE.md niet genoeg duiding bij licentie?
Voor duiding omtrent deze laatst genoemde werd contact opgenomen met TapQuo via e-mail.
De auteurs hebben tot op het moment van schrijven geen antwoord ontvangen.
...
%TODO ``bij het naar beneden trekken van een lijst waarbij de data automatisch wordt herladen'' bondiger volgens sven?  Zit ook in kendo dus niet suuuuuuuper opmerkelijk
...
%TODO referentie naar documentatie van quo?
...
\item \textbf{Routing }
%TODO uitgebreid <> bondige/beknopte documentatie
...
%TODO ``de zijnavigatie'' moet deze niet eerst gemaakt worden ofzo? Of is die altijd standaard aanwezig?
