...
Daarna volgt \kendo{}~(\ref{sec:raamwerk-kendo}) die zowel \js{}- als opmaakgedreven is .
...
De applicatie kan ook gebouwd worden als een \term{native} applicatie voor iOS en Android door de webapplicatie om te vormen.
...
%TODO moeten die termen niet met hoofdletter?
\begin{description}
...
Deze komt met een GNU's Not Unix General Public License v3~(GNU GPLv3) \term{open-source} licentie wat wil zeggen dat de vrijheid bestaat om aanpassingen aan de broncode te maken en te verspreiden,  zolang de code ook maar gratis verspreid wordt voor alle gebruikers.
...
Een \code{Proxy} voor serveropslag kan data verzenden voor hetzelfde domein via Asynchronous JavaScript and XML~(AJAX) of tussen verschillende domeinen via JSONP.  
...
Data-attributen kunnen een HTML-element associëren met \kendo{} of het overeenkomstige jQuery-object met \js{} het element initialiseren.
...
%TODO 1 klassensysteem of meerdere klassensystemen?
...
Hierbij dient enkel de code binnen de \code{body}-tag te worden opgeslaan.
