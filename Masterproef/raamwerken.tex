...
Alle \temr{widgets}, zoals gebruikt in het raamwerk, ondersteunen \term{progressive enhancement}.
...
\paragraph{Tools}
Het is ook mogelijk om gebruik te maken van Codiqa~\cite{Sperry2012} om met \term{drag-and-drop} de GI-elementen op het scherm te zetten. 
