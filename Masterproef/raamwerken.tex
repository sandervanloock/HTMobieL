...
\paragraph{Documentatie}
De documentatie staat op \exturl{lungo.tapquo.com/howto/prototype/} waar eerst getoond wordt hoe het geraamte van een typische \lungo{}-applicatie er uitziet.
...
De documentatie van de onderliggende \js{}-bibliotheek wordt gevonden op \exturl{quojs.tapquo.com}.
Deze bestaat uit één pagina met een zeer summiere samenvatting van de API.
