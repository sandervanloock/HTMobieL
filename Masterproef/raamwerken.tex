...
\subsection{Omkadering}
\paragraph{Programmeertaal}
\kendo{} kan zowel als JavaScript en \term{markup} gedreven beschouwd worden.  
...
Het gebruik van widgets van \kendo{} Web vereist wel dat ze met JavaScript worden opgebouwd.

Het laden van het raamwerk kan door heel \kendo{} op te roepen of enkel de \kendo{} Mobile door respectievelijk \code{kendo.all.js} en \code{kendo.mobile.js}.
Op een analoge wijze kan de programmeur kiezen tussen twee \term{stylesheets},  \code{kendo.all.css} en \code{kendo.mobile.css}.
...
Voor \term{backend} ondersteuning in PHP,  JSP of ASP.NET MVC betaal je $\$300$ meer.
...
\subsection{Functionele kenmerken}
%observable objecten => binding
%klassensysteem
\kendo{} is zowel \term{markup} als JavaScript gedreven en steunt op de MVVM-architectuur.
...
Er zijn verschillende bindings mogelijk tussen een \code{view} en {ObservableObject} en wordt aangegeven in de \code{data-bind}-tag.
