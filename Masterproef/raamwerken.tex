...
\st{} wordt ontwikkeld door Sencha.
Dit een bedrijf is in 2010 is ontstaan als een samensmelting van drie raamwerken:  Ext JS, jQuery Touch en Raphaël. 
...
Dit is een desktopapplicatie die het ontwikkelingsproces vergemakkelijkt met een GGI en \term{drag-and-drop} commando's~\cite{Sencha2012a}.  
...
Deze tool vergemakkelijkt de ontwikkeling van \st{} applicaties door middel van commando's die vanuit de \term{command-line} kunnen worden uitgevoerd~\cite{Sencha2012}.
...
\kendo{} is een raamwerk van het Duitse Telerik en in novermber 2011 gelanceerd.
...
Het raamwerk biedt \term{widgets} aan voor meer geavanceerde functionaliteit, die onderliggend een plug-in van jQuery voorstellen.
...
\paragraph{View}
Schermen worden voorgesteld met \code{Views},  analoog als bij het MVC-ontwerppatroon.
...
\jqm{} biedt alle elementen voor formulieren aan zoals tekstinvoer, een selectie uit een lijst, een zoekveld, een \term{slider} en een schakelaar. 
...
%TODO moet hier dan ook die 4 raamwerken staan, want nergens herhalen we in onze captions dan nog die namen?
