...
Als je een \code{listView} wil maken met data van een externe databron kan je best de \code{DataSource} laden bij het initializeren van de applicatie,  de lijst maken na de \code{init}-gebeurtenis van de \code{View} van de lijst en de lijst verversen wanneer deze getoond wordt (\code{show} gebeurtenis).
