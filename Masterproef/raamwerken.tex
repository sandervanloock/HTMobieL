...
\subsection{Code en ontwikkeling}
Alle moet code in JavaScript worden geschreven en dient één HTML-bestand slechts als container om de bestanden in te laden.  
...
Vervolgens kunnen data attributen in HTML-code het element associëren met \kendo{} of kan het overeenkomstige jQuery object in JavaScript het raamwerk oproepen en het element initialiseren.
Alle UI-elementen van \kendo{} Mobile kunnen met data-attributen worden opgebouwd.
Widgets van \kendo{} Web kunnen zowel met JavaScript als data-attributen geïnitialiseerd worden.
...
Hier kunnen de vereiste elemeten geselecteerd worden en wordt het vereiste JavaScript-bestand gegenereerd.
...
Voor \kendo{} Mobile kan een verschillende lay-out bepaalt worden voor alle ondersteunde platformen.
...
De JavaScript- en CSS-bestanden van het raamwerk moeten in de projectfolder worden gekopieerd respectievelijk in een \term{js} en \term{styles} map.
...
Hier kunnen parameters meegegeven worden die bijvoorbeeld de stijl van één platform vastlegd voor alle toestellen of het initiële scherm bepalen.
...
Het stijlen van de elementen op andere platformen zal werken, maar is beperkt tot  enkel tekst invoer~\cite{Telerike}.
...
\paragraph{View}
Schermen worden voorsteld met \code{Views},  analoog als bij de MVC-architectuur.
