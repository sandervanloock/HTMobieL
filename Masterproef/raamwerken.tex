...
%De keuze van de raamwerken wordt eerst gemotiveerd in sectie~\ref{sec:motivatie-vier-raamwerken}.
...
%TODO beter inleiding dan motivatie? want ik moet spreken over die types raamwerken… 
...
De applicatie kan worden gedownload voor Mac, Windows en Linux distributies~\cite{Sencha2012a}.
%TODO prijs vermelden

\subparagraph{Sencha Cmd}
Deze tool kan de initiële applicaties opzetten,  bestanden toevoegen en de applicatie bouwen en uitrollen~\cite{Sencha2012}.
%TODO uitwerken
...
%TODO tekst hoger zitten ivm actief/passief
