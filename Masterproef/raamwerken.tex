...
Daarna worden deze raamwerken, namelijk \jqm{}~(\ref{sec:raamwerk-jqm}), \st{}~(\ref{sec:raamwerk-st}), \kendo{}~(\ref{sec:raamwerk-kendo}) en \lungo{}~(\ref{sec:raamwerk-lungo}) uitvoerig besproken.
...
% Tim: als je het al met een hoofdletter schrijft is het al duidelijk zonder het commando \term te gebruiken. dacht dat we het zo hadden afgesproken?
...
%TODO Tim: is de kracht de MVVM of ook die zowel js- als opmaakgedrevenheid?
...
%TODO Tim: 'id' woordje lateen opvallen (term of code?)
...
%TODO Tim: bij het laatste van de zin loopt er wat mis precies..
...
\item \textbf{Core }
%TODO Sander: onderstaande zin? Tim: wat is nu je vraag? ;-)
...
In tabel~\ref{tabel:raamwerken-tabel} wordt de vergelijking getoond van de vier raamwerken.
