...
Op een analoge wijze, kan de programmeur kiezen tussen verschillende stijlbladen:  \code{kendo.all.css} en \code{kendo.mobile.css}.
...
Een licentie met \term{backend} integratie garandeerd professionele ondersteuning binnen 24 uur.
...
\paragraph{Tools}
%TODO onderstaande paragraaf geldt voor alle frameworks (opmerking gonzalo bij sencha)
...
%TODO geldt dit niet voor alles wat op git staat en component.json bevat?
...
%TODO ``zeer sumiere samenvatting'' pas in evaluatie vermelden?
...
%TODO ik zou die jammer genoeg weglaten :)
...
%TODO onderstaande zin klopt niet,  array gn nederlands
...
\item \textbf{Service }
%TODO zonder meer vanuit het lungo
...
%TODO deze functionaliteit is zit ook in jquery ajax he,  als ik het goed begrijp is het zels browser specifiek en niet afh van js
