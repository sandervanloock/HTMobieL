...
\section{Motivatie voor de gekozen raamwerken}
%TODO
...
Dit is een andere desktopapplicatie voor de ontwikkeling van een GGI met behulp van \term{drag-and-drop} commando's.  
...
Een \code{Proxy} voor opslag aan client zijde kan zowel in het RAM-geheugen als in de \term{local storage} van de browser opslaan.  
...
%Ik maak ook gebruik van Kendo UI Web in de POC, maar in principe is Kendo UI Mobile perfect alleenstaand.  
%Ze sluiten elkaar ook niet uit dus zou ik gewoon bij Kendo UI blijven..
\section{\kendo}
...
%TODO Tim: MVVM uitleggen (gebeurt later in tekst...)
...
% TODO Tim: valt getting started onder een 'term' Sander: ik wou de specifieke term zoals in de documentatie gebruiken.. alternatief?
...
%TODO Sander: zelfde opmerking als literatuurstudie:  raamwerken objectief voorstellen, nog niet vergelijken naar andere ?
...
Daarnaast zijn er nog acht andere hoofdstukken die de aangeboden GI-elementen en API uitleggen.
Op de documentatiepagina's is altijd eerst de broncode te zien.
%TODO Sander: `levensecht`` => live ? :) ofzoiets..
...
%TODO Sander: zelfde opmerking als literatuurstudie:  raamwerken objectief voorstellen, nog niet vergelijken naar andere ?
%staat hier echt vol referenties naar jqm... (dit is toch slechts een voorstelling van raamwerken)
...
\item \textbf{Service }
%TODO Sander: 'zonder enig probleem'
...
\subsection{Niet-functionele kenmerken}
\paragraph{Performantie}
%TODO Sander: onderstaande zin zou ik veranderen.  Weeral, objectiviteit
...
%TODO Sander: 'ziet er goed uit' :) Maaike en Marjan zien er ook goed uit maar anderen vinden dit misschien niet...
...
%TODO Sander: ik snap onderstaande zin niet goed. consistente ervaring? 
...
\pgfplotstabletypeset[
  begin table=\begin{tabular}{p{2.5cm} p{2.5cm} p{2.5cm} p{2.5cm} p{2.5cm}},
