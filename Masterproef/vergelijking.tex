...
%TODO Sander: mss verduidelijken dat deze fases door een werknemer worden uitgevoerd.
%Ik kreeg het gevoel dat de schrijfstijl veranderd.  Soms wordt er naar 'zijn', 'hij', ... verwezen,  dan weer is er de beschrijvende stijl met een verwijzing naar 'de werknemer`.. snapte? :)
\begin{enumerate}
...
%TODO Sander: staat dat in POC? deze feature komt voort uit de vorige
...
%TODO Tim: 'extra' loginscherm, 'daarnaast' Sander: ksnap het niet
...
%Sander: evt. alle assumpties ook met equations weergeven.  Dan kunnen we er altijd naar verwijzen als we ze nodig hebben??
...
%Sander: zullen we paragraaf motivatie doen
...
\end{table}
\begin{equation}
  G_r = \sum_{i=1}^{14}{\left(U_{r,i}\right)}
  \label{eq:gebruik}
\end{equation}
...
\begin{equation}
  G_c = G(BS_d)*G(BS_{c,v})*G(Browser_c)
...
\begin{table}[h]
  ...
  \begin{tabular}{lllll}
    ...
    \midrule
    HTCDesireZ & Smartphone & Android 2.3.3 & Android browser & $G_d = 62586$\\ %75.0*45.6*18.30
    GalaxyTab & Tablet & Android 2.3.6 & Android browser & $G_d = 62586$\\ %75.0*45.6*18.30
    GalaxyS & Smartphone  & Android 4.1.2 & Chrome & $G_d = 1848.3$\\ %75.0*12.2*2.02
    Nexus 7 & Tablet & Android 4.2.1  & Chrome & $G_d = 1848.3$\\ %75.0*2*2.02
    iPad3 1 WiFi & Tablet & iOS 5.1.1 & Mobile Safari & $G_d = 15910.965$\\%14.9*17.5*61.02
    iPad3 4G WiFi & Tablet & iOS 6.0.1 & Mobile Safari & $G_d = 36367.92$\\%14.9*40.0*61.02
    iPhone 3GS & Smartphone & iOS 6.0.1 & Mobile Safari & $G_d = 36367.92$\\%14.9*40.0*61.02
    iPhone 4S & Smartphone & iOS 6.0.1 & Mobile Safari & $G_d = 36367.92$\\%14.9*40.0*61.02
    \bottomrule
  \end{tabular}
