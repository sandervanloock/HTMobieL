...
\begin{equation}
  \text{Totale downloadtijd}_r= \sum_{c=1}^{8}{\left(\widehat{l}_{r,c,login}+\widehat{l}_{r,c,login_{cache}}\right)}
...
\begin{equation}
  \text{Performantie}_r= \frac{\text{Totale downloadtijd}_r + \text{Totale rendertijd}_r}{8}
