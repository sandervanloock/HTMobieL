...
%TODO beter argumenteren populariteitscriterium
...
%TODO find and replace te snel gedaan? populariteitscriteriumcriterium
De som van Twitter volgers ($T_r$), \gh{} sterren ($S_r$), \gh{} \term{forkers} ($F_r$), \so{} vragen ($SO_r$) en \fb{} vind-ik-leuks ($FB_r$) vormt de score voor het populariteitscriteriumcriterium:
\begin{equation}
