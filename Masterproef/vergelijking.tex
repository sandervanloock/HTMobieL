...
%TODO referenties zijn naar blogposts
De populariteit van een raamwerk is belangrijke factor want het bepaalt de gemeenschap en levendigheid van het raamwerk.
...
Dit is belangrijk want bedrijven willen zo mogelijk tijd verliezen om met nieuwe technolgieën aan de slag te kunnen.
...
%TODO Ook in de vergelijking van Burris werd een loginapplicatie gekozen om \st{} en \jqm{} te vergelijken~\cite{Burris}.
...
Hier meer functionaliteiten het raamwerken te bieden heeft,  hoe bruikbaarder het is.
%TODO geen refs naar blog
%Bij de ISO 25010-standaard probeert de categorie functionele geschiktheid dezelfde eigenschappen te testen
...
Het is belangrijk dat een zo breed mogelijk publiek met éénzelfde applicatie kan worden aangesproken.
%TODO De Cross Platform Capabilities zoals beschreven in op de Codefessions blogpost~\cite{Sarrafi2012a} geven een score aan raamwerken om gelijkaardige redenen.
% De categorie overdraagbaarheid van de ISO 25010-standaard beschrijft ook de mate waarin een systeem, product of component effectief en efficiënt overgezet kan worden van één hardware, software of andere operationele of gebruiksomgeving naar een andere.
...
Het is noodzakelijk dat een applicatie zowel snel wordt gedownload als gebruikerservaring is.
%TODO refs naar blogs en ISO
