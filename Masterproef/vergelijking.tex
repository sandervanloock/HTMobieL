...
\paragraph{}
De som van Twitter volgers($T_f$), GitHub sterren($G_s$), GitHub forkers ($G_f$), Stackoverflow vragen ($G_{so}$) en Facebook likes($F_f$) vormt de score voor het gemeenschapscriteria:
