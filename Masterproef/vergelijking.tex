...
%TODO Dit is een grafiek waar elke score in de overeenkomstige as met relatieve schaal wordt geplot.
...
\paragraph{Motivatie}
TODO
% van bewust dat dubbel tellen,  is maar een indicatie wat betreft community
% van bewust dat stackoverflow zowel slecht als goed kan zijn.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%TODO login uitgebreidt met lijst van 850 elementen => 850 liedjes 
%http://answers.yahoo.com/question/index?qid=20110315195858AAAsqHA
...
\begin{table}[h]	
  ...
  \begin{tabular}{ll}
    ...
    $U_{r,i} = 1$ & Een plug-in is nodig of nieuwe kenmerken van HTML5\\ %TODO verder uitleggen (CSS3 valt onder nieuwe kenmerken van koepel html5)
    $U_{r,i} = 0$ & Eigen implementatie of hack of niet geïmplementeerd\\ %niet implementeren is niet verder tijd ingestoken (alles is implementeerbaar)
    \bottomrule
  \end{tabular}
...
%TODO keuze van devices verklaren (phablet ?)

%TODO relatieve score ondersteuning: quoteer enkel wat supported is
...
%TODO De tijden voor het laden van de volledige POC zullen gemeten worden met pcapperf..
...
%TODO ook meten logintijd + gecachte versie
...
%TODO bespreken downloadtijd, LOC, GPS en 
...
%TODO enkele zaken die bekeken zullen worden ter verklaring van de score:
...
% Gebruikerservaring adhv scrollen door lange lijst (relatieve score)
%TODO tabel scores
%TODO AJAX
...
%Alle relatieve scores uitleggen
