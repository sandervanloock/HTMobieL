...
Hoofdzakelijk zal dit gebeuren aan de hand van een \term{proof of concept}.
...
Dit werd uitgewerkt door Capgemini en geleverd aan de auteurs als \term{mockup}.
...
Ze verwezen naar een blogpost waarbij een spinnenweb werd gebruikt om \term{native} en webapplicaties met elkaar te vergelijken~\cite{Jeroen2012}.
...
%TODO -alternatief AHP, nadeel is
% 1) redo evaluate (puntje 2 van paper \cite{Saaty1980}) is grootste nadeel als er een nieuw criteria wordt toegevoegd, bij ons kan je er een gewoon inklikken. we willen een goeie methode creëren.
% 2) we zijn een thesis met 2, dus dan gingen we altijd tezamen moeten zitten voor evaluatie. want de vergelijking is relatief t.o.v. elkaar.
...
Net zoals webapplicaties willen \term{cross-platform} tools zo veel mogelijk platformen bereiken.
Dit werd door meer dan $75\%$ van de ondervraagde ontwikkelaars in het Vision Mobile rapport aangehaald als hoofdreden om \term{cross-platform} tools te gebruiken~\cite{Mobile2012}. 
