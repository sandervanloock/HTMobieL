...
% TODO Tim: mijn gevoel was eerst dat je algemeen spiderweb uitlegd en dan voor ons gevoel, nu is het alsof een spiderweb altijd uit 5 dimensies bestaat
...
%TODO Tim: onderstaande zin herschrijven
...
%TODO Tim: 'extra' loginscherm, 'daarnaast'
Elk zullen ze de POC en een extra loginscherm maken in vier verschillende raamwerken maken.
%TODO Tim: mogen wij niet concreet onze namen en raamwerken al invullen?
...
\begin{equation}
	%TODO Tim: ik zou PR gebruiken ipv Pr, omdat die _r het zo onduidelijk maakt anders
...
%TODO Tim: mooie oplossing hiervoor vinden, vragen aan Gonzalo?
...
%TODO Tim: misschien ook uitleggen waarom we er 3 gekozen hebben en bv. niet de 4 van mij… 'omdat we raamwerken testen en niet pure HTML5/CSS3'
...
%TODO Tim: waarom geen u voor uitdaging?
...
%Onderstaande wordt verplaatst naar hoofdstuk raamwerken
...
\begin{table}[h]
  ...
  \begin{tabular}{lllll}
    ...
    \midrule
    HTCDesireZ & Smartphone & Android 2.3.3 & Android browser & $W_d = 62586$\\ %75.0*45.6*18.30
    GalaxyTab & Tablet & Android 2.3.6 & Android browser & $W_d = 62586$\\ %75.0*45.6*18.30
    GalaxyS & Smartphone  & Android 4.1.2 & Chrome & $W_d = 1848.3$\\ %75.0*12.2*2.02
    Nexus 7 & Tablet & Android 4.2.1  & Chrome & $W_d = 1848.3$\\ %75.0*2*2.02
    iPad3 1 WiFi & Tablet & iOS 5.1.1 & Mobile Safari & $W_d = 15910.965$\\%14.9*17.5*61.02
    iPad3 4G WiFi & Tablet & iOS 6.0.1 & Mobile Safari & $W_d = 36367.92$\\%14.9*40.0*61.02
    iPhone 3GS & Smartphone & iOS 6.0.1 & Mobile Safari & $W_d = 36367.92$\\%14.9*40.0*61.02
    iPhone 4S & Smartphone & iOS 6.0.1 & Mobile Safari & $W_d = 36367.92$\\%14.9*40.0*61.02
    \bottomrule
  \end{tabular}
...
%TODO Tim: beeter GI ipv UI gebruiken
...
%TODO Tim: ik zou PE gebruiken, door Pe_r is het net alsof er Per staat ofzo ;-)
\begin{equation}
