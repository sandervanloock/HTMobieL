...
Ext.define('Ext.ux.PDF', {
    ...
    constructor: function(config){
        ...
        if (!config.hidePagingtoolbar) {
            ...
            /*config.items = Ext.create('Ext.Toolbar',{
            	items: [
    ...
    loadPdf: function(src, extraParams, data, password) {
        var me = this;
        src = src || me.getSrc();
        extraParams = extraParams || me.getExtraParams();
